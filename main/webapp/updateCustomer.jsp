...
<body>
	...
	<form action="update" method="post">
		...
		<tr>
		<td>ID</td>
		<td><input type="text" name="id" value="<%=id%>" readonly><br></td>
		</tr>
		<tr>
		<td>FIRST NAME</td>
		...
		<tr>
		<td>LAST NAME</td> 
		<td><input type="text" name="lastname" value="<%=lastname%>"><br></td>
		</tr>
		<tr>
		...
		<tr>
		<td> MOBILE NUMBER</td>
		<td><input type="text" name="mobile" value="<%=mobile%>"><br></td>
		</tr>
		<tr>
		<td>NIC NUMBER</td>
